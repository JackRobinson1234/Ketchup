...
struct PostLeaderboard: View {
    ...
    // Helper function to get the formatted date range for the current week
    var body: some View {
        NavigationStack {
            VStack {
                                    ...
                                    Button {
                                        ...
                                        HStack(spacing: 8) {
                                            ...
                                            HStack(spacing: 8) {
                                                ...
                                                // Stacked details (restaurant name, username, rating, likes)
                                                VStack(alignment: .leading) {
                                                    // Restaurant Name
    ...
    private func fetchPosts() {
        ...
        Task {
            do {
                topPosts = try await viewModel.fetchTopPosts(count: 10, state: state, city: city)
                isLoading = false
            } catch {
    ...
    private func getCurrentMonth() -> String {
        ...
        dateFormatter.dateFormat = "MMMM yyyy" // Full month name and year (e.g., September 2023)
