...
//struct PollCommentCell: View {
//    let comment: PollComment
//    let replies: [PollComment]
//    @ObservedObject var viewModel: PollCommentViewModel
//    let isReply: Bool
...
//                    PollCommentCell(comment: reply, replies: [], viewModel: viewModel, isReply: true)
//                        .padding(.leading, 20)
//                }
//            }
//        }
...
//        .background(
//            Rectangle()
//                .fill(comment.isHighlighted ?? false ? Color.red.opacity(0.1) : Color.clear)
//        )
...
//                }
//            }) {
//                Image(systemName: (comment.didLike ?? false) ? "heart.fill" : "heart")
//                    .foregroundColor((comment.didLike ?? false) ? .red : .gray)
//                    .font(.system(size: 16))
//            }
//            
//            if comment.likes > 0 {
...
//        .background(isSwiped ? Color.red : Color.gray.opacity(0.2))
//    }
//    
