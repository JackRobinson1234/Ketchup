    ...
    var body: some View {
        NavigationStack{
            VStack(alignment: .leading, spacing: 20) {
                ...
                if let location = editProfileViewModel.location {
                    HStack {
                        ...
                        Spacer()
                        Button(action: {
                            editProfileViewModel.location = nil
                ...
                //            Button(action: {
                //                editProfileViewModel.location = localSelectedLocation
                //            }) {
            ...
            search.start { (response, error) in
                ...
                CLGeocoder().reverseGeocodeLocation(location) { placemarks, error in
                    ...
                    DispatchQueue.main.async {
                        editProfileViewModel.location = Location(
                            city: city,
                            state: state,
