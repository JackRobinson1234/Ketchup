...
struct UploadService {
    ...
    func uploadPost(videoURL: URL?, images: [UIImage]?, mediaType: String, caption: String, postType: PostType, postRestaurant: PostRestaurant?, postRecipe: PostRecipe?, fromInAppCamera: Bool) async throws {
